...
const Users = () => {
  const [users, setUsers] = useState([
    ...
    },
    {
      ...
      autoGeneratedPassword: 'Kj8#mN2pQ'
    },
    {
      id: 3,
  ...
  const handlePasswordChangeSubmit = (e) => {
    ...
    setUsers(prev => prev.map(user => 
      user.id === selectedUser.id 
        ? { ...user, isPasswordChanged: true, autoGeneratedPassword: null }
        : user
    ));
  ...
  const getRoleBadgeClass = (role) => {
    const roleClasses = {
      ...
      'terminal_manager': 'badge-manager'
    };
                    ...
                    <td>
                      {user.autoGeneratedPassword ? (
                        <div className="password-info">
                          ...
                          <span className="password-text">{user.autoGeneratedPassword}</span>
                        </div>
                      ) : (
                      ...
                      <div className="action-buttons">
                        ...
                        {!user.isPasswordChanged && (
                          <button 
                            ...
                            onClick={() => openPasswordChangeForm(user)}
                          >
                            Change Password
                          </button>
                        )}
